    ...
    <div>
      <div id="#about" className="w-full pt-16">
        <div className="mx-8 xl:mx-auto max-w-1200 xxl:max-w-1440">
          ...
          <h1 className="my-4">Interpretation and Definitions</h1>
          <h2 className="my-4">Interpretation</h2>
          <p>
          ...
          <h2 className="my-4">Definitions</h2>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Raya Health, The Raya Clinic 2505
                25th Floor, Centuria Medical Makati, Century City, Gen. Luna
                St., Brgy. Poblacion, Makati City, Philippines.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Raya Health, accessible from{" "}
                <a
                  href="https://raya-health.com/"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://raya-health.com/
                </a>
              </p>
            </li>
            <li>
          ...
          <h1 className="my-4">Collecting and Using Your Personal Data</h1>
          <h2 className="my-4">Types of Data Collected</h2>
          <h3 className="my-4">Personal Data</h3>
          <p>
          ...
          <h3 className="my-4">Usage Data</h3>
          ...
          <h3 className="my-4">Tracking Technologies and Cookies</h3>
          <p>
          ...
          <h2 className="my-4">Use of Your Personal Data</h2>
          ...
          <h2 className="my-4">Retention of Your Personal Data</h2>
          <p>
          ...
          <h2 className="my-4">Transfer of Your Personal Data</h2>
          <p>
          ...
          <h2 className="my-4">Disclosure of Your Personal Data</h2>
          <h3 className="my-4">Business Transactions</h3>
          <p>
          ...
          <h3 className="my-4">Law enforcement</h3>
          <p>
          ...
          <h3 className="my-4">Other legal requirements</h3>
          <p>
          ...
          <h2 className="my-4">Security of Your Personal Data</h2>
          <p>
          ...
          <h1 className="my-4">Changes to this Privacy Policy</h1>
          <p>
          ...
          <ul>
            <li>By email: info@raya-health.com</li>
          </ul>
        </div>
      </div>
    </div>
