...
const AddCeirForm = (props) => {
  ...
  const onFinish = (values) => {
    ...
    if (action === "add") {
      ...
      dispatch(
        patientAddCeir(formData, () => {
          showMessage("success", "CEIR details added succcessfully!");
          form.resetFields();
