...
export const HealthScreeningConsentForm = ({
    ...
    if (sigCanvas.current.isEmpty()) {
      ...
      dispatch(
        adminUpdatePatientVaccinatinStatus(
          patientId,
          {
            consent_date: moment(new Date()).format("YYYY-MM-DD"),
  ...
  return (
    <div className="max-h-80 overflow-y-auto">
      <p className="mb-4">
        ...
        the distributed MODERNA COVID-19 vaccine, its Emergency Used
        ...
        distributed MODERNA vaccines without prejudice to immediate eligibility
      ...
      <p className="mb-4">
        ...
        administration of, or the ineffectiveness of the MODERNA COVID-19
        vaccine.
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ...
        found to be associated with the MODERNA COVID-19 vaccine or its
      ...
      <p className="mb-4">
        I hereby give my consent to be vaccinated with the MODERNA COVID-19
        Vaccine.
      </p>
